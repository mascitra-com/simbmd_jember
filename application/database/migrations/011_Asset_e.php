<?php
class Migration_Asset_e extends CI_Migration {
    ...
    public function up() {
        $this->dbforge->add_field(array(
            ...
            'buku_judul'        =>array('type'=> 'VARCHAR','constraint'=>255),
            'buku_spesifikasi'  =>array('type'=> 'VARCHAR','constraint'=>255),
            'barang_asal'       =>array('type'=> 'VARCHAR','constraint'=>255),
            'barang_pencipta'   =>array('type'=> 'VARCHAR','constraint'=>255),
            'barang_bahan'      =>array('type'=> 'VARCHAR','constraint'=>255),
            'hewan_jenis'       =>array('type'=> 'VARCHAR','constraint'=>255),
            'hewan_ukuran'      =>array('type'=> 'VARCHAR','constraint'=>255),
            'jumlah'            =>array('type'=>'INT', 'constraint'=>7),
        ...
        $this->dbforge->create_table('asset_e');
    }

    public function down() {
        $this->dbforge->drop_table('asset_e');
    }
}