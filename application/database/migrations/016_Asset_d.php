<?php
class Migration_Asset_d extends CI_Migration {
    ...
    public function up() {
       $this->dbforge->add_field(array(
            ...
            'panjang'           =>array('type'=> 'INT','constraint'=>10),
            'lebar'             =>array('type'=> 'INT','constraint'=>10),
            ...
            'nomor_tanah'       =>array('type'=> 'INT','constraint'=>10),          
        ...
        $this->dbforge->create_table('asset_d');
    }

    public function down() {
        $this->dbforge->drop_table('asset_d');
    }
}