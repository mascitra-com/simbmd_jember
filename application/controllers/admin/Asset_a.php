...
class Asset_a extends MY_Controller {
	...
	{
		parent::__construct();
		$this->load->model('admin/Kiba_model', 'kib');
	...
	public function index()
	{
		...
		$this->render('modules/admin/asset_a/index', $data);
	}
	...
	public function add()
	{
		$data['categories']	= $this->category->order_by('nama')->get_all();
		$data['skpds'] = $this->skpd->order_by('name')->get_all();
		$this->render('modules/admin/asset_a/import', $data);
	}
	...
	public function edit($id = null)
	{
		...
		$data['skpds']		= $this->skpd->order_by('name')->get_all();
		$data['categories'] = $this->category->order_by('nama')->get_all();
		$this->render('modules/admin/asset_a/form', $data);
	}
