...
class Asset_b extends MY_Controller {
	...
	{
		parent::__construct();
		$this->load->model('admin/Kibb_model', 'kib');
	...
	public function index()
	{
		...
		$this->render('modules/admin/asset_b/index', $data);
	}
	...
	public function add()
	{
		$data['categories']	= $this->category->order_by('kode')->get_all();
		$data['skpds'] = $this->skpd->order_by('name')->get_all();
		$this->render('modules/admin/asset_b/import', $data);
	}
	...
	public function edit($id = null)
	{
		...
		$data['skpds']		= $this->skpd->order_by('name')->get_all();
		$data['categories'] = $this->category->order_by('kode')->get_all();
		$this->render('modules/admin/asset_b/form', $data);
	}
