...
class Asset_e extends MY_Controller {
	...
	{
		parent::__construct();
		$this->load->model('admin/Kibe_model', 'kib');
	...
	public function index()
	{
		...
		$this->render('modules/admin/asset_e/index', $data);
	}
	...
	public function add()
	{
		...
		$data['skpds'] = $this->skpd->order_by('name')->get_all();
		$this->render('modules/admin/asset_e/import', $data);
	}
	...
	public function edit($id = null)
	{
		...
		$data['skpds']		= $this->skpd->order_by('name')->get_all();
		$data['categories'] = $this->category->order_by('nama')->get_all();
		$this->render('modules/admin/asset_e/form', $data);
	}
