...
class Asset_c extends MY_Controller {
	...
	{
		parent::__construct();
		$this->load->model('user/Kibc_model', 'kib');
	...
	public function index()
	{
		...
		$this->render('modules/user/asset_c/index', $data);
	}

	public function add()
	{
		$data['categories']	= $this->category->order_by('kode')->get_all();
		$this->render('modules/user/asset_c/import', $data);
	}
	...
	public function add_rehab($id = null)
	{
		...
		$this->render('modules/user/asset_c/rehab', $data);
	}
	...
	public function insert_rehab()
	{
		...
		if($sukses) {
			...
			$this->go('user/asset_c/add_rehab/'.$data['asset_id']);
		}
	}
	...
	public function edit($id = null)
	{
		...
		$data['categories'] = $this->category->order_by('nama')->get_all();
		$this->render('modules/user/asset_c/form', $data);
	}
