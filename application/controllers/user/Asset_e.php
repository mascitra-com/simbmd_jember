...
class Asset_e extends MY_Controller {
	...
	{
		parent::__construct();
		$this->load->model('user/Kibe_model', 'kib');
	...
	public function index()
	{
		...
		$this->render('modules/user/asset_e/index', $data);
	}

	public function add()
	{
		$data['categories']	= $this->category->order_by('kode')->get_all();
		$this->render('modules/user/asset_e/import', $data);
	}
	...
	public function edit($id = null)
	{
		...
		$data['categories'] = $this->category->order_by('nama')->get_all();
		$this->render('modules/user/asset_e/form', $data);
	}
