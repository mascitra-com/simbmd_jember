	...
	<div class="col">
		<div class="card">
			...
			<div class="card-block">
				<form action="{{site_url('admin/asset_c/update')}}" method="POST">
					{{$csrf}}
					...
					<div class="form-group row">
						...
						<div class="col-md-4">
							<input type="text" class="form-control" name="pondasi" value="{{$kib->pondasi}}" placeholder="pondasi" />
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="col-md-4">
							<div class="input-group">
								<input type="number" class="form-control" name="luas_lantai" value="{{$kib->luas_lantai}}" placeholder="luas lantai" />
					...
					<div class="form-group row">
						...
						<div class="col-md-4">
							<div class="input-group">
								<input type="number" class="form-control" name="luas_bangunan" value="{{$kib->luas_bangunan}}" placeholder="luas bangunan" />
								<span class="input-group-addon">m&sup3</span> 
							</div>
						</div>
					</div>
					...
					<div class="form-group row">
						<div class="offset-md-2 col-md-4">
							...
							<a href="{{site_url('admin/asset_c')}}" class="btn btn-warning"><i class="fa fa-arrow-left mr-2"></i>Kembali</a>
						</div>
					</div>
				</form>
			</div>
