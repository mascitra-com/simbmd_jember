	...
	<div class="col">
		<div class="card">
			...
			<div class="card-block row">
				<div class="col-md-5">
					<form action="{{site_url('admin/asset_a/import')}}" method="POST" enctype="multipart/form-data">
						{{$csrf}}
						...
						<div class="form-group">
							...
							<a href="{{site_url('admin/asset_a')}}" class="btn btn-warning"><i class="fa fa-arrow-left mr-2"></i>kembali</a>
						</div>
					</form>
				</div>
				<div class="col">
	...
	<div class="col">
		<div class="card">
			...
			<div class="card-block">
				<form action="{{site_url('admin/asset_a/insert')}}" method="POST">
					{{$csrf}}
					<div class="row">
						<div class="col-md-6">
