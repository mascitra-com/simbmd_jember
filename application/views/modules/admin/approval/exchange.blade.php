@layout('common/main')
@section('title')Persetujuan Mutasi Data@endsection
	...
	<div class="col">
		<div class="card">
			<div class="card-header">
				<h4 class="card-title">Persetujuan Mutasi Data</h4>
			</div>
				...
				<table class="table table-hover table-striped">
					...
					<tbody>
						...
						<tr>
							...
							<td class="text-right">
								<a href="{{site_url('admin/approval/exchange_detail/kib'.$app->jenis_aset.'/'.$app->skpd_id)}}" class="btn btn-secondary btn-sm"><i class="fa fa-info mr-2"></i>selengkapnya</a>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="{{site_url('admin/approval/exchange_save')}}" method="POST">
					{{$csrf}}
