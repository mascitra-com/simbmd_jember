	...
	<div class="col">
		<div class="card">
			<div class="card-header form-inline">
				<!-- BATCH ACTION -->
				<form action="{{site_url('user/asset_a/batch_action')}}" method="POST" id="form-batch" class="hidden-sm-down">
					{{$csrf}}
				...
				<!-- ADD BUTTON -->
				<a href="{{site_url('user/asset_a/add')}}" class="btn btn-primary"><i class="fa fa-plus mr-2"></i>Tambah / Import</a>
			</div>
				...
				<div class="table-container">
					<table class="table table-striped table-hover table-bordered">
						<thead>
							...
							<!-- FILTER DATA  -->
							<form action="{{site_url('user/asset_a')}}" method="GET">
								<tr>
						...
						<tbody>
							...
							<tr>
								...
								<td class="text-nowrap">
									<div class="btn-group">
										<a href="{{site_url('user/asset_a/edit/'.$kib->id)}}" class="btn btn-sm btn-primary"><i class="fa fa-pencil"></i></a>
										<a href="{{site_url('user/asset_a/delete/'.$kib->id)}}" class="btn btn-sm btn-warning" onclick="return confirm('Apakah anda yakin?')"><i class="fa fa-trash"></i></a>
	...
	<div class="modal-dialog modal-sm" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="{{site_url('user/asset_a/exchange')}}" method="POST">
					{{$csrf}}
