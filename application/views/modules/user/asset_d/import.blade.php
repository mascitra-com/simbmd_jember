@layout('common/main')
@section('title')Import Data Aset KIB-D@endsection
	...
	<div class="col">
		<div class="card">
			...
			<div class="card-block row">
				<div class="col-md-5">
					<form action="{{site_url('user/asset_d/import')}}" method="POST" enctype="multipart/form-data">
						{{$csrf}}
						...
						<div class="form-group">
							...
							<a href="{{site_url('user/asset_d')}}" class="btn btn-warning"><i class="fa fa-arrow-left mr-2"></i>kembali</a>
						</div>
					</form>
				</div>
				<div class="col">
					...
					<a href="{{site_url('res/docs/pre/template_kibd.xls')}}" class="btn btn-primary"><i class="fa fa-download mr-2"></i>unduh format excel</a>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="col">
		<div class="card">
			...
			<div class="card-block">
				<form action="{{site_url('user/asset_d/insert')}}" method="POST">
					{{$csrf}}
					<div class="row">
						<div class="col-md-6">
							...
							<div class="form-group row">
								<label class="col-md-3 col-form-label">Kontruksi</label>
								<div class="col">
							...
							<div class="form-group row">
								<label class="col-md-3 col-form-label">Tanggak Dokumen</label>
								<div class="col">
						...
						<div class="col">
							...
							<div class="form-group row">
								<label class="col-md-3 col-form-label">Nomor Tanah</label>
								<div class="col">
