	...
	<div class="col">
		<div class="card">
			<div class="card-header form-inline">
				<!-- BATCH ACTION -->
				<form action="{{site_url('user/asset_c/batch_action')}}" method="POST" id="form-batch" class="hidden-sm-down">
					{{$csrf}}
				...
				<!-- ADD BUTTON -->
				<a href="{{site_url('user/asset_c/add')}}" class="btn btn-primary"><i class="fa fa-plus mr-2"></i>Tambah / Import</a>
			</div>
				...
				<div class="table-container">
					<table class="table table-striped table-hover table-bordered">
						<thead>
							...
							<!-- FILTER DATA  -->
							<form action="{{site_url('user/asset_c')}}" method="GET">
								<tr>
						...
						<tbody>
							...
							<tr>
								...
								<td class="text-nowrap">
									<div class="btn-group btn-group-sm" role="group" aria-label="...">
										<a href="{{site_url('user/asset_c/edit/'.$kib->id)}}" class="btn btn-warning"><i class="fa fa-pencil"></i></a>
										<a href="{{site_url('user/asset_c/delete/'.$kib->id)}}" class="btn btn-danger" onclick="return confirm('Apakah anda yakin?')"><i class="fa fa-trash"></i></a>
										<a href="{{site_url('user/asset_c/add_rehab/'.$kib->id)}}" class="btn btn-primary"><i class="fa fa-plus mr-2"></i><i class="fa fa-home"></i></a>
							...
							<tr class="hide rehab{{$kib->id}}">
								...
								<td class="text-center">
									<a href="{{site_url('user/asset_c/edit/'.$rehab->id)}}" class="btn btn-sm btn-warning"><i class="fa fa-pencil"></i></a>
									<a href="{{site_url('user/asset_c/delete/'.$rehab->id)}}" class="btn btn-sm btn-danger" onclick="return confirm('Apakah anda yakin?')"><i class="fa fa-trash"></i></a>
								</td>
	...
	<div class="modal-dialog modal-sm" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="{{site_url('user/asset_c/exchange')}}" method="POST">
					{{$csrf}}
