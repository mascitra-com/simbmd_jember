		...
		<div class="navbar-nav mr-auto">
			...
			<span class="nav-item mr-2 dropdown menu-aset">
				...
				<div class="dropdown-menu">
					<a class="dropdown-item" href="{{site_url('admin/asset_a')}}"><i class="fa fa-fw fa-cube mr-2"></i>KIB-A (Tanah)</a>
					<a class="dropdown-item" href="{{site_url('admin/asset_b')}}"><i class="fa fa-fw fa-car mr-2"></i>KIB-B (Peralatan &amp Mesin)</a>
					<a class="dropdown-item" href="{{site_url('admin/asset_c')}}"><i class="fa fa-fw fa-home mr-2"></i>KIB-C (Gedung &amp Bangunan)</a>
					<a class="dropdown-item" href="{{site_url('admin/asset_d')}}"><i class="fa fa-fw fa-road mr-2"></i>KIB-D (Jalan, Irigasi &amp Jaringan)</a>
					<a class="dropdown-item" href="{{site_url('admin/asset_e')}}"><i class="fa fa-fw fa-book mr-2"></i>KIB-E (Buku, Barang, Kebudayaan)</a>
					<a class="dropdown-item" href="{{site_url('admin/asset_f')}}"><i class="fa fa-fw fa-cogs mr-2"></i>KIB-F (Kontruksi)</a>
				</div>
			</span>
			<span class="nav-item mr-2 dropdown menu-persetujuan">
				<a class="nav-link dropdown-toggle" data-toggle="dropdown">
					<i class="fa fa-check mr-1"></i>Persetujuan
					@if ($notif['ON_UPDATE'] != "0" OR $notif['ON_DELETE'] != "0" OR $notif['ON_INSERT'] != "0" OR $notif['ON_IMPORT'] != "0" OR $notif['ON_EXCHANGE'] != "0")
						<i class="fa fa-circle text-red notification"></i>
					@endif
				</a>
				<div class="dropdown-menu">
					<span class="dropdown-item">Aset</span>
					<a class="dropdown-item" href="{{site_url('admin/approval/insert')}}"><i class="fa fa-plus mr-2"></i>Tambah {{$notif['ON_INSERT'] != "0" ? "<span class='badge badge-danger'>".$notif['ON_INSERT']."</span>" : ''}}</a>
					...
					<a class="dropdown-item" href="{{site_url('admin/approval/import')}}"><i class="fa fa-upload mr-2"></i>Import {{$notif['ON_IMPORT'] != "0" ? "<span class='badge badge-danger'>".$notif['ON_IMPORT']."</span>" : ''}}</a>
					<a class="dropdown-item" href="{{site_url('admin/approval/exchange')}}"><i class="fa fa-exchange mr-2"></i>Mutasi {{$notif['ON_EXCHANGE'] != "0" ? "<span class='badge badge-danger'>".$notif['ON_EXCHANGE']."</span>" : ''}}</a>
				</div>
			</span>
