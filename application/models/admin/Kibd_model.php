...
class Kibd_model extends MY_Model {
	...
	private function db_formated($data, $skpd_id)
	{
		...
		# SET KOLOM
		$column = array('category_id', 'nama', 'kode_barang', 'reg', 'kontruksi', 'panjang', 'lebar', 'luas', 'alamat', 'tahun_pengadaan', 'nomor_dokumen', 'status_tanah', 'nomor_tanah', 'asal_usul', 'nilai', 'kondisi', 'keterangan');
		$final = array();
