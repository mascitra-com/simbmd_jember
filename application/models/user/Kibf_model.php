...
class Kibf_model extends MY_Model {
	...
	private function db_formated($data, $skpd_id)
	{
		...
		# SET KOLOM
		$column = array('category_id', 'nama', 'kode_barang', 'bangunan', 'tingkat', 'beton', 'luas', 'alamat', 'tanggal_dokumen', 'nomor_dokumen', 'tanggal_mulai', 'status_tanah', 'kode_tanah', 'asal_usul', 'nilai', 'keterangan');
