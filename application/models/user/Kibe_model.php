...
class Kibe_model extends MY_Model {
	...
	private function db_formated($data, $skpd_id)
	{
		...
		# SET KOLOM
		$column = array('category_id', 'nama', 'kode_barang', 'reg', 'buku_judul', 'buku_spesifikasi', 'barang_asal', 'barang_pencipta', 'barang_bahan', 'hewan_jenis', 'hewan_ukuran', 'jumlah', 'tahun_pengadaan', 'asal_usul', 'nilai', 'keterangan');
