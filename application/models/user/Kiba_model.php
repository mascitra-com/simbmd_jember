...
class Kiba_model extends MY_Model {
	...
	private function db_formated($data, $skpd_id)
	{
		...
		# SET KOLOM
		$column = array('category_id', 'nama', 'kode_barang', 'reg', 'luas', 'tahun_pengadaan', 'alamat', 'hak', 'tanggal_sertifikat', 'nomor_sertifikat', 'pengguna', 'asal_usul', 'nilai', 'keterangan');
